<div class="container">
	...
	<div class="mb-3">
		<h2 class="title">Hasil Pencarian untuk "<?= $keyword ?>"</h2>
		<p class="mb-0">Ditemukan <?= $total_products ?> produk</p>
	</div>
				...
				<div class="toolbox-left">
					<div class="toolbox-item toolbox-sort">
						...
						<div class="select-custom">
							<select name="sort" class="form-control" onchange="window.location.href='<?= base_url('product?sort=') ?>'+this.value">
