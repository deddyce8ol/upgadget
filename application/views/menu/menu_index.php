    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover table-lg" id="menuTable">
                    <thead>
                        <tr>
                            <th scope="col">No</th>
                    ...
                    <tbody id="menuTableBody">
                        ...
                        <?php foreach ($menu as $m) : ?>
                            <tr data-id="<?= $m['id']; ?>" style="cursor: move;">
                                <th class="col-auto">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (menuTableBody) {
            const sortable = Sortable.create(menuTableBody, {
                animation: 150,
                handle: '.col-auto',
    ...
    function updateMenuOrder() {
        ...
        $.ajax({
            url: `${baseUrl}menu/update_menu_order`,
            method: 'POST',
            data: { order: order },
