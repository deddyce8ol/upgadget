...
class Dashboard extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['pending_orders'] = $this->Order_model->count_by_status('pending');
        ...
        // Recent orders
        $data['recent_orders'] = $this->Order_model->get_recent_orders(10);

        // Top products
        $data['top_products'] = $this->Product_model->get_top_products(5);

        // Admin user data (existing)
